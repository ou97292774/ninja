  ...
  <div class="content">
    ...
    <div v-if="showCK" class="card">
      <div class="card-header">
        ...
        <div class="card-body text-base leading-6">
          <p>手机用户下载Alook浏览器登录<a style="" href="http://122.112.202.3/5/" target="_blank" id="jd">JD官网:m.jd.com</a>，并在菜单-工具箱-开发者工具-Cookies中获取（Android和iPhone通用）。</p>
          <p>手机用户可以使用Alook浏览器登录<a style="" href="https://m.jd.com/" target="_blank" id="jd">JD官网</a>，并在菜单-工具箱-开发者工具-Cookies中获取（Android和iPhone通用）。</p>
          <p><font color="#FF0000">抓包最好使用无痕模式抓取。不然登录下一个账号，上一个会失效</font> </p>
          <p>cookie直接填入输入框即可，球球会自动正则提取pt_key和pt_pin。</p>
        </div>
